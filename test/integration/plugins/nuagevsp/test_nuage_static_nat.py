...
class TestNuageStaticNat(nuageTestCase):
    ...
    @attr(tags=["advanced", "nuagevsp"], required_hardware="false")
    def test_02_nuage_StaticNAT_isolated_networks(self):
    ...
    @attr(tags=["advanced", "nuagevsp"], required_hardware="false")
    def test_03_nuage_StaticNAT_vpc_networks(self):
    ...
    def test_04_nuage_StaticNAT_isolated_networks_traffic(self):
    ...
    @attr(tags=["advanced", "nuagevsp"], required_hardware="true")
    def test_05_nuage_StaticNAT_vpc_network_traffic(self):
    ...
    @attr(tags=["advanced", "nuagevsp"], required_hardware="true")
    def test_06_nuage_StaticNAT_acl_rules_traffic(self):
        ...
        # "test_04_nuage_StaticNAT_isolated_networks_traffic" and
        # "test_05_nuage_StaticNAT_vpc_network_traffic" with different Egress
    ...
    @attr(tags=["advanced", "nuagevsp"], required_hardware="true")
    def test_07_nuage_StaticNAT_vm_nic_operations_traffic(self):
        """Test Nuage VSP Static NAT functionality with VM NIC operations by
        performing (wget) traffic tests to the Internet
        """

        # Repeat the tests in the testcase
        # "test_04_nuage_StaticNAT_isolated_networks_traffic" with VM NIC
        # operations:
    ...
    @attr(tags=["advanced", "nuagevsp"], required_hardware="true")
    def test_08_nuage_StaticNAT_vm_migration_traffic(self):
        """Test Nuage VSP Static NAT functionality with VM migration by
        performing (wget) traffic tests to the Internet
        """

        # Repeat the tests in the testcase
        # "test_04_nuage_StaticNAT_isolated_networks_traffic" with migration of
    ...
    @attr(tags=["advanced", "nuagevsp"], required_hardware="true")
    def test_09_nuage_StaticNAT_network_restarts_traffic(self):
        ...
        # Repeat the tests in the testcases
        # "test_04_nuage_StaticNAT_isolated_networks_traffic" and
        # "test_05_nuage_StaticNAT_vpc_network_traffic" with network restarts:
