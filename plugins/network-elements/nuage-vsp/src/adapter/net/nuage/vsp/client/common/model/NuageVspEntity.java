...
public enum NuageVspEntity {
    ...
    INGRESS_ACLTEMPLATES("ingressacltemplates", NuageVspAttribute.ID, NuageVspAttribute.EXTERNAL_ID, NuageVspAttribute.INGRESS_ACLTEMPLATES_NAME, NuageVspAttribute.INGRESS_ACLTEMPLATES_DESCRIPTION,
            NuageVspAttribute.INGRESS_ACLTEMPLATES_ACTIVE, NuageVspAttribute.INGRESS_ACLTEMPLATES_ALLOW_IP, NuageVspAttribute.INGRESS_ACLTEMPLATES_ALLOW_NON_IP, NuageVspAttribute.INGRESS_ACLTEMPLATES_ENTRIES),
    ...
    EGRESS_ACLTEMPLATES("egressacltemplates", NuageVspAttribute.ID, NuageVspAttribute.EXTERNAL_ID, NuageVspAttribute.EGRESS_ACLTEMPLATES_NAME, NuageVspAttribute.EGRESS_ACLTEMPLATES_DESCRIPTION,
            NuageVspAttribute.EGRESS_ACLTEMPLATES_ACTIVE, NuageVspAttribute.EGRESS_ACLTEMPLATES_ALLOW_IP, NuageVspAttribute.EGRESS_ACLTEMPLATES_ALLOW_NON_IP, NuageVspAttribute.EGRESS_ACLTEMPLATES_ENTRIES),
    ...
    EGRESS_FIP_ACLTEMPLATES("egressfloatingipacltemplates", NuageVspAttribute.ID, NuageVspAttribute.EXTERNAL_ID, NuageVspAttribute.EGRESS_FIP_ACLTEMPLATES_NAME, NuageVspAttribute.EGRESS_FIP_ACLTEMPLATES_DESCRIPTION,
            NuageVspAttribute.EGRESS_FIP_ACLTEMPLATES_ACTIVE, NuageVspAttribute.EGRESS_FIP_ACLTEMPLATES_ALLOW_IP, NuageVspAttribute.EGRESS_FIP_ACLTEMPLATES_ALLOW_NON_IP, NuageVspAttribute.EGRESS_FIP_ACLTEMPLATES_ENTRIES),
    EGRESS_FIP_ACLTEMPLATES_ENTRIES("egressfloatingipaclentrytemplates", NuageVspAttribute.ID, NuageVspAttribute.EXTERNAL_ID, NuageVspAttribute.PARENT_ID, NuageVspAttribute.EGRESS_FIP_ACLTEMPLATES_ENTRY_ACTION,
                    NuageVspAttribute.EGRESS_FIP_ACLTEMPLATES_ENTRY_DEST_PORT, NuageVspAttribute.EGRESS_FIP_ACLTEMPLATES_ENTRY_ETHER_TYPE, NuageVspAttribute.EGRESS_FIP_ACLTEMPLATES_ENTRY_LOCATION_TYPE,
